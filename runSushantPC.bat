...
python launcher.py -n 128random_diameter7test.edgelist -c 3.333333333333333333333333333333333333 -r 50
...
python launcher.py -n 256random_diameter5test.edgelist -c 3.333333333333333333333333333333333333 -r 50
